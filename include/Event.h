...
class Event {
    ...
    public:
        ...
        // Construtor completo
        Event(int event_time, event_type type, int pack_id, std::string& sender, std::string& recipient, int origin_warehouse, int destination_warehouse, int next_warehouse) :
